...
fixtures 只含 synthetic facts 和来源索引，不含第三方题干、选项、答案、解析、OCR 或 PDF 正文。P4.6/P4.7 已收口；P4.8/P4.9 及 Phase 4 Gate 状态见 [`docs/PHASE4_VALIDATION_REPORT.md`](../../../docs/PHASE4_VALIDATION_REPORT.md)。
